#!/usr/bin/env python3
"""
5-Minute Scalping Bot with Leverage - LONG & SHORT
"""
...
from ml_trainer_bidirectional import BidirectionalMLTrainer
...
class Scalping5mBot:
    def __init__(self):
        ...
        self.tp_percent = TRADING_CONFIG.get('tp_percent', 0.008)
        self.sl_percent = TRADING_CONFIG.get('sl_percent', 0.004)
        self.confidence_threshold = 0.65
        
    def initialize(self):
        print("🚀 5-MINUTE SCALPING BOT WITH LEVERAGE")
        print("=" * 50)
        
        if not self.ml_trainer.load_ml_models():
            print("❌ Please train bidirectional models first")
            return False
            
        print("✅ Bidirectional ML Models Loaded")
