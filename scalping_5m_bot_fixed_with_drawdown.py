...
class Scalping5mBotFixed:
        ...
        while iteration < 48:  # Run for 4 hours
            ...
            try:
                ...
                if signal_data:
                    ...
                    drawdown_color = "🔴" if drawdown > 0 else "🟢"
                    
                    print(f"💰 Balance: ${self.balance:.2f}")
                    print(f"📉 Drawdown: {drawdown_color}{drawdown:.2f}%")
                else:
                    print(f"📊 Price: ${current_price:.2f}")
    ...
    def show_final_summary(self):
        ...
        max_drawdown = (self.peak_balance - min(self.balance, self.peak_balance)) / self.peak_balance * 100
