#!/usr/bin/env python3
"""
5-Minute Scalping Bot with Fixed Bidirectional ML - FUTURES VERSION
"""
...
class Scalping5mBotFixed:
    def __init__(self):
        ...
        # Scalping parameters
        self.leverage = 10
        self.tp_percent = 0.05  # 0.8%
        self.sl_percent = 0.025 # 0.4%
        self.confidence_threshold = 0.60  # Slightly lower for more signals
        self.position_size = 0.2  # 20% of balance per trade

        # ✅ CORRECTED: Binance FUTURES trading fees (not spot)
        self.maker_fee = 0.0002  # 0.02% for futures
        self.taker_fee = 0.0004  # 0.04% for futures

    def initialize(self):
        print("🚀 5-MINUTE SCALPING BOT WITH FIXED BIDIRECTIONAL ML")
        print("=" * 50)
        print("✅ OPTIMIZED FOR BINANCE FUTURES TRADING")
        ...
        print(f"💰 Trading Fees: {self.taker_fee*100:.3f}% (taker) / {self.maker_fee*100:.3f}% (maker)")
        print("🎯 Trading: LONG & SHORT positions (FUTURES)")
        return True
    ...
    def execute_trade(self, signal, current_price):
        ...
        # ✅ CORRECTED: Calculate trading fee using futures rates
        ...
        if signal['prediction'] == 'LONG' and not self.position:
            ...
            if should_exit:
                ...
                # ✅ CORRECTED: Calculate exit fee using futures rates
    ...
    def run_scalping(self):
        ...
        print("🎯 Trading LONG & SHORT with 10x Leverage (FUTURES)")
        print("💰 Using Binance Futures Fee Structure")
        print("=" * 50)
