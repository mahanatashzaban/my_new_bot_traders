...
class Scalping5mBotFixed:
    def __init__(self):
        ...
        # Scalping parameters
        self.leverage = 10
        self.tp_percent = 0.015  # 1.0%
        self.sl_percent = 0.007  # 0.4%
    ...
    def initialize(self):
        ...
        print(f"💰 Trading Fees: {self.taker_fee*100:.1f}% (taker)")  # ENABLED
    ...
    def execute_trade(self, signal, current_price):
        ...
        if signal['prediction'] == 'LONG' and not self.position:
            ...
            self.position = {
                ...
                'entry_fee': entry_fee  # ENABLED
            }

            # Apply entry fee - ENABLED
            ...
            if should_exit:
                ...
                trade = {
                    ...
                    'exit_fee': exit_fee,  # ENABLED
                    'total_fee': total_fee  # ENABLED
                }
                self.trade_log.append(trade)
                ...
                print(f"       Exit Fee: ${exit_fee:.4f} | Total Fees: ${total_fee:.4f}")  # ENABLED
    ...
    def show_final_summary(self):
        ...
        # Calculate total fees - ENABLED
        total_fees = sum(trade.get('total_fee', 0) for trade in self.trade_log if 'total_fee' in trade)
        print(f"💰 TOTAL FEES: ${total_fees:.4f}")

        # Calculate net PnL (after fees)
        gross_pnl = sum(trade.get('pnl_amount', 0) for trade in self.trade_log if 'pnl_amount' in trade)
